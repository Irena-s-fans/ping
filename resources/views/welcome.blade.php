...
<div class="popup" id="popup1">
    <div class="popup__body">
        <div class="popup__content">
            ...
            <p class="popup__text">Все, что мы делаем, основано на принципе построения <span class="about__text_purple">значимых связей</span>. <br>
                ...
                <div class="section swiper-slide">
                    <div class="section__wrapper">
                        ...
                        <div class="quest">
                            ...
                            <p class="quest__text">
                                Наша задача состоит в том, чтобы предлагать<span class="about__text-purple">инновационные и креативные кампании</span>, которые находят отклик в игровом сообществе.
                            </p>
                                ...
                                <div class="form__wrap">
                                    ...
                                    <div class="form__item">
                                        ...
                                        <div class="form__texarea-wrap">
                                            <textarea class="form__textarea" id="message" name="message" cols="30" rows="10"></textarea>
                                        </div>

...
<div class="container main main_disabled">
    ...
    <div class="content splide" id="fullpage">
        <div class="splide__track">
            <div class="splide__list">
                <div class="section splide__slide" id="about_section">
                ...
                <div class="section splide__slide" id="services_section">
                    <div class="section__wrapper section__wrapper_no-overflow">
                        ...
                        <div class="services__wrap services__wrap_active" id="services">
                            ...
                            <div class="services__list_sm">
                                <div class="splide" id="services__splide">
                                    <div class="splide__track">
                                        <div class="splide__list">
                                            <div class="services__list-item services__list-item_sm splide__slide show-services" rel="tournaments">
                                                <img class="services__list-img" src="/public/img/services/dir_desc_1.png" alt="">
                                                <p class="services__list-text">Турниры</p>
                                            </div>
                                            <div class="services__list-item services__list-item_sm splide__slide">
                                                <img class="services__list-img" src="/public/img/services/dir_desc_2.png" alt="">
                                                <p class="services__list-text">Спец проекты</p>
                                            </div>
                                            <div class="services__list-item services__list-item_sm splide__slide">
                ...
                <div class="section splide__slide" id="team_section">
                    <div class="section__wrapper">
                        <div class="team">
                ...
                <div class="section splide__slide" id="reviews_section">
                    <div class="section__wrapper">
                        ...
                        <div class="review__content splide" id="review__list">
                            <div class="splide__track">
                                <div class="splide__list">
                                    <div class="review__row splide__slide">
                                        <div class="review__el">
                                            <div class="review__el-header">
                                                <img src="" alt="" class="review__el-avatar">
                ...
                <div class="section splide__slide" id="contacts_section">
                    <div class="section__wrapper">
                        <div class="contacts">
